...
function start(){
  stroke(0);
    ...
    fill("black");
    textSize(20);
    text("Corona virus has taken over the world, leaving all locked up in their homes. This pandemic has affected thousands of peoples,", 25, 150);
   text(" who are either sick or are being killed due to the spread of this disease. Let's learn how we can keep us safe. Click start to play.",25,170)
